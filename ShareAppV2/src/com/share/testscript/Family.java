...
{
	GeneralFunctions GeneralFunctions = new com.share.general.GeneralFunctions();
	...
	public void TC_Family_001(Method method) throws Exception
	{
		...
		test.info("Family Head Sent Invites");
	...
	public void TC_Family_002(Method method) throws Exception
	{
		...
		try
		{
			...
			GeneralFunctions.isElementPresent(familyPage.InvalidEmailWarning, 60);
			if(familyPage.InvalidEmailWarning.isDisplayed())
			{
				test.log(Status.PASS, "Please Enter a Valid email address Dispalyed");
				Thread.sleep(6000);
			}
			else
			{
